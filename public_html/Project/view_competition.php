...
LEFT JOIN (SELECT * FROM Arcade_UserComps where Arcade_UserComps.user_id = :uid) as t on t.competition_id = Arcade_Competitions.id WHERE Arcade_Competitions.id = :cid");
$row = [];
$comp = "";
try {
